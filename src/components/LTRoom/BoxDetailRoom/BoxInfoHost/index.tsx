          ...
          <CardWithSideText
            ...
            subtitle = {
              <View style = {{display: 'flex', alignItems: 'flex-start', backgroundColor: 'white', paddingTop: 4}}>
                <View>
                  <Text
                    style = {styles.subtitleShopInfoText}>{t('details:listing')}: {listing.merchant.data.number_room}</Text>
                </View>
                {/*{listing.merchant.data.city ? (*/}

                {/*  <View style = {{flexDirection: 'row'}}>*/}
                {/*    <Ionicons name = 'ios-pin' size = {11} style = {{paddingRight: 4, alignSelf: 'center'}}*/}
                {/*              color = {'#767676'} />*/}
            ...
            rightInfo = {
              <TouchableWithScale _onPress = {() => navigation.navigate('MerchantInfo', { idUser: listing.merchant_id })}
                                  style = {styles.btnViewMerchant}>
...
const styles             = StyleSheet.create({
  ...
  btnViewMerchant:{
    ...
    alignItems: 'center',
    borderRadius: 360,
    borderColor: COLOR_TEXT_SUBTITLE,
  }
});
BoxInfoHost.defaultProps = {};
export default withNavigation(BoxInfoHost);
