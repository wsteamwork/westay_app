...
const Tab1_DescriptionEN: FC<IProps> = (props) => {
  const { } = props;
  ...
  return (
    <CreateListingLayout titleHeader={t('create_details:titleStep')} titleMain={t('create_basic:tab1')}>
      <View style={styles.row}>
        <Text style={styles.txtTitle}>{t('create_details:listingNameEN')}</Text>
      ...
      <View style={styles.row}>
        <Text style={styles.txtTitle}>{t('create_details:listingDesEN')}</Text>
      ...
      <View>
        ...
        <View style={styles.row}>
          <Text style={styles.txtTitle}>{t('create_details:listingSpaceEN')}</Text>
        ...
        <View style={styles.row}>
          <Text style={styles.txtTitle}>{t('create_details:listingRulesEN')}</Text>
...
export default Tab1_DescriptionEN;
